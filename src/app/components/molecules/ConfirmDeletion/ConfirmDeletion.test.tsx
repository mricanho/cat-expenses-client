...
describe('ConfirmDeletion Component - Functionality and Styles', () => {
    ...
    it('calls onClose when the Cancel button is clicked', () => {
        ...
        render(
            <ConfirmDeletion isOpen={true} onClose={handleClose} onConfirm={() => { }} />
        );
    ...
    it('calls onConfirm when the Confirm button is clicked', () => {
        ...
        render(
            <ConfirmDeletion isOpen={true} onClose={() => { }} onConfirm={handleConfirm} />
        );
    ...
    it('applies the correct styles to the modal content', () => {
        ...
        const modalContent = screen.getByText('Are you sure you want to delete the selected items?');
