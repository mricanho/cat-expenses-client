...
describe('Button Component - Styles and Functionality', () => {
  it('renders with default styles', () => {
    ...
    expect(buttonElement).toHaveClass('button button-medium button-default button-border-none');
  });

  it('applies the small size styles', () => {
    render(<Button onClick={() => { }} size="small">Small Button</Button>);
  ...
  it('applies the large size styles', () => {
    render(<Button onClick={() => { }} size="large">Large Button</Button>);
  ...
  it('applies the primary color styles', () => {
    render(<Button onClick={() => { }} color="primary">Primary Button</Button>);
  ...
  it('applies the danger color styles', () => {
    render(<Button onClick={() => { }} color="danger">Danger Button</Button>);
  ...
  it('applies the solid border styles', () => {
    render(<Button onClick={() => { }} border="solid">Solid Border Button</Button>);
